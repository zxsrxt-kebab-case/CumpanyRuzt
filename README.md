...
В данной статье расскажу как владелец сервера **CompanyRust**, [Aloyya](https://www.youtube.com/@aloyyarust) может скрытно воровать ваши аккаунты, грузить вам любые файлы и выполнять их, подставлять обычных игроков, а так же использовать это все **ради собственной выгоды**.
...
## Как можно подставить любых игроков?

Начнем с самого интересного, что выяснилось вообще абсолютно случайно, без цели это найти.

В античите присутствует функция, которая позволяет делать скриншоты экрана и отправлять их админам, чтобы увидеть чит-функции на экране игрока.

Однако не все так однозначно. В процессе ресерча того, как они делают скриншоты, я наткнулся на очень подозрительные вызовы функций рисования.

В плагине **COMPANY.dll** присутствует зависимость в одной библиотеке, которая позволяет рисовать всякие примитивы, по типу **квадратов, линий, градиентов** и т.д.

Как вы думаете, зачем это вообще нужно, если плагин вообще ничего не **рисует**? Даже настройки плагина находятся в настройках игры, собственно рисовать нечего здесь.

Ниже будут все функции рисовки:

<figure>
  <img src="1.png" alt="1" width="1000">
  <figcaption>Создание кисти для рисовки</figcaption>
</figure>
<figure>
  <img src="2.png" alt="2" width="1000">
  <figcaption>Рисовка заполненного квадрата</figcaption>
</figure>
<figure>
  <img src="3.png" alt="3" width="1000">
  <figcaption>Создание Ручки для рисовки</figcaption>
</figure>
<figure>
  <img src="4.png" alt="4" width="1000">
  <figcaption>Рисовка обычного квадрата(без заполнения)</figcaption>
</figure>
<figure>
  <img src="5.png" alt="5" width="1000">
  <figcaption>Создание кисти с эффектом градиента</figcaption>
</figure>
<figure>
  <img src="6.png" alt="6" width="1000">
  <figcaption>Рисовка линий</figcaption>
</figure>
<figure>
  <img src="8.png" alt="8" width="1000">
  <figcaption>рисовка кругов</figcaption>
</figure>
<figure>
  <img src="9.png" alt="9" width="1000">
  <figcaption>Рисовка текста(строк)</figcaption>
</figure>

Данный псевдокод был взят из их плагина в классе <span class="codetext">
COMPANYBOOSTER.UI.ScreenHooks."<"SaveScreenshotAsync">"d__20 </span>

Как вы думаете для чего это может использоваться? конечно же, что бы рисовать **ESP или Чит-Меню** на скриншотах собранных с вашего компьютера. 

Таким образом админы могут спокойно рисовать на скриншотах вообще **все что захотят**.
